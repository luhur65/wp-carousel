...
(function ($) {
  ...
  function SP_WPCP_FrameworkAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SP_WPCP_FrameworkAjaxChosen.prototype.init = function () {
  ...
  SP_WPCP_FrameworkAjaxChosen.prototype.events = function () {
  ...
  SP_WPCP_FrameworkAjaxChosen.prototype.search_field_focused = function () {
  ...
  SP_WPCP_FrameworkAjaxChosen.prototype.search_welcome_message = function () {
  ...
  SP_WPCP_FrameworkAjaxChosen.prototype.update_list = function () {
    ...
    this.timer = setTimeout(function () {
      ...
      _this.chosenXhr = window.wp.ajax.post('sp_wpcp-chosen', _this.options.data).done(function (response) {
  ...
  SP_WPCP_FrameworkAjaxChosen.prototype.show_results = function (items) {
    ...
    if (this.is_multiple) {
      ...
      var $hidden_select = this.element.parent().find('.sp_wpcp-hide-select');
      var $hidden_value = $hidden_select.val() || [];

      this.element.SP_WPCP_FrameworkChosenOrder($hidden_value, true);
  ...
  $.fn.SP_WPCP_FrameworkAjaxChosen = function (chosenOptions) {
    return this.each(function () {
      new SP_WPCP_FrameworkAjaxChosen(this, chosenOptions);
    });
  };
...
(function () {
  var $, SP_WPCP_FrameworkAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function (item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function (child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SP_WPCP_FrameworkAbstractChosenOrder = (function () {

    function SP_WPCP_FrameworkAbstractChosenOrder() { }

    SP_WPCP_FrameworkAbstractChosenOrder.insertAt = function (node, index, parentNode) {
      if (typeof parentNode.children[index] !== "undefined") {
        return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
      }
    };

    SP_WPCP_FrameworkAbstractChosenOrder.getFlattenedOptionsAndGroups = function (select) {
    ...
    SP_WPCP_FrameworkAbstractChosenOrder.isValidMultipleSelectElement = function (element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SP_WPCP_FrameworkAbstractChosenOrder.getChosenUIContainer = function (select) {
      if (select.id !== "") {
    ...
    SP_WPCP_FrameworkAbstractChosenOrder.isChosenified = function (select) {
      return this.getChosenUIContainer(select) != null;
    };

    SP_WPCP_FrameworkAbstractChosenOrder.forceSelection = function (select, selection) {
    ...
    SP_WPCP_FrameworkAbstractChosenOrder.SP_WPCP_FrameworkChosenOrder = function (select, order, force) {
    ...
    return SP_WPCP_FrameworkAbstractChosenOrder;
  ...
  $.fn.extend({
    SP_WPCP_FrameworkChosenOrder: function (order, force) {
      return _SP_WPCP_FrameworkChosenOrder.SP_WPCP_FrameworkChosenOrder(this, order, force);
    }
  });

  this._SP_WPCP_FrameworkChosenOrder = (function (_super) {
    __extends(_SP_WPCP_FrameworkChosenOrder, _super);

    function _SP_WPCP_FrameworkChosenOrder() {
      _ref = _SP_WPCP_FrameworkChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SP_WPCP_FrameworkChosenOrder.relAttributeName = 'data-option-array-index';

    _SP_WPCP_FrameworkChosenOrder.isjQueryObject = function (obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SP_WPCP_FrameworkChosenOrder.getDOMElement = function (element) {
    ...
    _SP_WPCP_FrameworkChosenOrder.searchChosenUIContainer = function (element) {
    ...
    _SP_WPCP_FrameworkChosenOrder.triggerEvent = function (target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SP_WPCP_FrameworkChosenOrder;

  })(SP_WPCP_FrameworkAbstractChosenOrder);
    ...
    applyRule: function (context, enforced) {
      ...
      if (result) {
        ...
        $(controls).each(function () {
          $(this).removeClass('sp_wpcp-depend-on');
        });
        ...
        $(controls).each(function () {
          $(this).addClass('sp_wpcp-depend-on');
        });
...
(function (root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSP_WPCP_Framework = FormSerializer.serializeObject;
    $.fn.serializeJSONSP_WPCP_Framework = FormSerializer.serializeJSON;
  }
