 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'SP_WPCP_Framework_Field_radio' ) ) {
	class SP_WPCP_Framework_Field_radio extends SP_WPCP_Framework_Fields {
		...
		public function render() {
			...
			$inline_class = ( $args['inline'] ) ? ' class="sp_wpcp--inline-list"' : '';
