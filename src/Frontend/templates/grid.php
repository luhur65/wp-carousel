 ...
 * Grid.
 *
 * This template can be overridden by copying it to yourtheme/wp-carousel-pro/templates/grid.php
 *
...
?>
<div id="wpcpro-wrapper-<?php echo esc_attr( $post_id ); ?>" class="wpcp-carousel-wrapper wpcpro-wrapper wpcp-gallery wpcp-wrapper-<?php echo esc_attr( $post_id ); ?> <?php echo $img_protection ? ' wpcp_img_protection' : ''; ?>">
	<?php
