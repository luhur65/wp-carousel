 ...
 * Masonry.
 *
 * This template can be overridden by copying it to yourtheme/wp-carousel-pro/templates/masonry.php
 *
...
?>
<div id="wpcpro-wrapper-<?php echo esc_attr( $post_id ); ?>" class="wpcp-carousel-wrapper wpcpro-wrapper wpcp-gallery wpcp-masonry wpcp-wrapper-<?php echo esc_attr( $post_id ); ?> <?php echo $img_protection ? ' wpcp_img_protection' : ''; ?>">
	<?php
	...
	<div id="sp-wp-carousel-pro-id-<?php echo esc_attr( $post_id ); ?>" class="<?php echo esc_attr( $carousel_classes ); ?>" <?php echo $lightbox_setting; ?>>
		<div class="wpcpro-row wpcp-masonry">
